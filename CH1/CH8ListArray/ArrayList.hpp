...
#ifndef CH9ARRAYLIST_ARRAYLIST_HPP
#define CH9ARRAYLIST_ARRAYLIST_HPP
...
//    friend std::ostream operator<<(ArrayList<ItemType> &x, std::ostream &out);
}; // end ArrayList
...
//template<class ItemType>
//std::ostream ArrayList<ItemType>::operator<<(ArrayList<ItemType> &x, std::ostream &out, ) {
...
#endif //CH9ARRAYLIST_ARRAYLIST_HPP
